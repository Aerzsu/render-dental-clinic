...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AddField(
            ...
            name='created_by',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='created_timeslot_configs', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
        ...
        migrations.AddIndex(
            model_name='timeslotconfiguration',
            index=models.Index(fields=['date'], name='timeslot_config_date_idx'),
        ),
        migrations.AddIndex(
            model_name='paymenttransaction',
        ...
        migrations.AddIndex(
            model_name='appointment',
            index=models.Index(fields=['appointment_date', 'start_time'], name='appt_date_time_idx'),
        ),
        migrations.AddIndex(
            model_name='appointment',
